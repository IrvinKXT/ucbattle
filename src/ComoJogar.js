...
function ComoJogar() {
    return (
        <div className='ComoJogar--Container'>
            ...
            <div className='Topico'>
                <h2>O que é o modo treino?</h2>
                <p>
                    O modo treino é um modo onde é possível praticar e entender como o jogo funciona sem ser
                    penalizado por errar. O modo treino está disponível para ser acessado a qualquer momento.
                </p>
            </div>
            <div className='Topico'>
            ...
            <div className='Topico'>
                <h2>Sobre a Narração</h2>
                <p>
                    No jogo, em opções, há uma opção para desligar e ligar 
                    a narração das perguntas, alternativas das fazes, das dicas
                    e também dos quadrinhos. Ao ligar essa opção, um novo botão 
                    aparece nas fazes, o botão Repetir Narração. Com esse botão 
                    é possível repetir a pergunta e as alternativas a qualquer 
                    momento. Para repetir uma dica basta apertar o botão de Habilidade 
                    novamente.
                </p>
            </div>
